    $('.play-trailer').on('click',function(e){
        e.preventDefault()
        $("#video-page-title-pro").addClass('d-none');
	...
	const controlsContainer = document.querySelector('.video-box .controls-container');

	const playPauseButton = document.querySelector('.video-box .controls button.play-pause');
	const rewindButton = document.querySelector('.video-box .controls button.rewind');
	const fastForwardButton = document.querySelector('.video-box .controls button.fast-forward');
	const volumeButton = document.querySelector('.video-box .controls button.volume');
	const fullScreenButton = document.querySelector('.video-box .controls button.full-screen');
	...
	const progressBar = document.querySelector('.video-box .progress-controls .p-bar');
	const watchedBar = document.querySelector('.video-box .progress-controls .p-bar .watched-bar');
	const timeLeft = document.querySelector('.video-box .progress-controls .time-remaining');
