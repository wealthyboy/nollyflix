...
var Img = {
    ...
    deleteImage: function(opts ={}){
        ...
        $(document).on('click',opts.activator,function(e){
            ...
            parent = activator.parents('.uploadloaded_image');
            parent.find('.upload_input').wrap('<form id="clearfiles"></form>')
            document.getElementById("clearfiles").reset();
            parent.find('.upload_input').unwrap()
            parent.find('.upload_input').removeAttr('required').attr('required',true)
            let params = { 
                ...
                $.ajax({
                    ...
                    beforeSend: function(xhr){
                       // opts.inputFile.attr('disabled',true)
                        ...
                        console.log(parent.find("label#big_poster-error"))
