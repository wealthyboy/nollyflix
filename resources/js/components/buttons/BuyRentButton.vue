    ...
    <div>
        ...
        >
            <span class="purchase-btn-icon  p-4">
                <svg viewBox="0 0 16 16">
                    <path
                        d="M13.781 7.25A3.96 3.96 0 0014 6a4 4 0 00-4-4C8.247 2 6.774 3.135 6.233 4.704A2.487 2.487 0 004.5 4 2.5 2.5 0 002 6.5c0 .273.055.531.135.776A3.5 3.5 0 003.5 14h9a3.5 3.5 0 003.5-3.5c0-1.48-.921-2.738-2.219-3.25zM6 11.25v-4.5L10.5 9 6 11.25z"
                    ></path>
                </svg>
            </span>
        ...
        <template v-if="$root.video.access_type == 'is_for_rent_and_buy'">
            <a
                ...
                data-toggle="modal"
                data-target="#apModal"
                @click="buyOrRent('Buy', $root.video.converted_buy_price)"
                class="d-flex flex-row mb-2 rounded-0 btn-primary"
            >
                <span class="purchase-btn-icon  p-4">
                    <svg viewBox="0 0 16 16">
                ...
                <span class="purchase-btn-price-text-wrap p-3">
                    Buy {{ $root.video.currency
                    }}{{ $root.video.converted_buy_price }}
                    <div class="purchase-btn-price-subtext">
                        Streaming anytime
                    </div>
                </span>
            </a>
            <a
                ...
                data-toggle="modal"
                data-target="#apModal"
                @click="buyOrRent('Rent', $root.video.converted_rent_price)"
                class="d-flex flex-row rounded-0 btn-primary mb-4"
            >
                ...
                <div class="purchase-btn-price-text-wrap p-3">
                    Rent {{ $root.video.currency
                    }}{{ $root.video.converted_rent_price }}
                    <div class="purchase-btn-price-subtext">
        ...
        <a
            href="#!"
            v-if="$root.video.access_type == 'is_only_for_rent'"
            data-toggle="modal"
            data-target="#apModal"
            @click="buyOrRent('Rent', $root.video.converted_rent_price)"
            class="d-flex flex-row rounded-0 btn-primary mb-4"
        ...
        <a
            href="#!"
            v-if="$root.video.access_type == 'is_only_for_buy'"
            data-toggle="modal"
            data-target="#apModal"
            @click="buyOrRent('Buy', $root.video.converted_buy_price)"
            class="d-flex flex-row mb-2 rounded-0 btn-primary"
        ...
        <div class="learn-more">
            <span>Watch on iOS, Android and Desktop.</span>
