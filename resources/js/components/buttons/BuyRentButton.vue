<template>
    <div>
        <a href="#!" data-toggle="modal" data-target="#checkoutModal" @click="buyOrRent('Buy')"  class="d-flex flex-row mb-2 rounded-0 btn-primary">
        ...
        <a href="#!" data-toggle="modal" data-target="#checkoutModal" @click="buyOrRent('Rent')"  class="d-flex flex-row rounded-0 btn-primary mb-4">
