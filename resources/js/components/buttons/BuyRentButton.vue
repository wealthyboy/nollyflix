<template>
    <div>
        <a href="#!" v-if="$root.video.access_type == 'is_free'" data-toggle="modal" data-target="#apModal" @click="buyOrRent('Buy',$root.video.converted_buy_price)"  class="d-flex flex-row mb-2 rounded-0 btn-primary">
