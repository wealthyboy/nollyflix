...
<div class="flexslider progression-studios-slider">
    <ul class="slides">
        <li class="progression_studios_animate_left">
            <div class="progression-studios-slider-image-background" style="background-image:url({{ $featured->video->poster }});">
                        ...
                        <div class="container">
                            ...
                            <div class="progression-studios-slider-caption-width">
                                <div class="progression-studios-slider-caption-align">
                                    <h2><a href="/">{{ $featured->video->title }}</a></h2>
                                    <ul class="slider-video-post-meta-list">
                                        ...
                                        <li class="slider-video-post-meta-rating"><span>PG-{{ $featured->video->film_rating }}</span></li>
                                    </ul>
                                    <div class="clearfix"></div>
                                    <div class="progression-studios-slider-excerpt">{{ html_entity_decode($featured->video->description) }}</div>
                                    ...
                                    <video id=""  class="d-none" poster="{{ $featured->video->poster }}" width="960" height="540">
