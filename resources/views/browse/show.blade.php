                            ...
                            <div class="progression-studios-slider-caption-width">
                                <div class="progression-studios-slider-caption-align">
                                    ...
                                    <ul class="slider-video-post-meta-list">
                                        ...
                                        <li class="slider-video-post-meta-rating"><span>PG-{{ optional($video)->film_rating }}</span></li>
                                    </ul>
                                    <div class="clearfix"></div>
                                    <div class="progression-studios-slider-excerpt"><?php echo html_entity_decode($video->description) ?></div>
                                    <a class="btn btn-slider-pro" data-fancybox  href="{{ optional($video)->preview_link }}"><i class="far fa-play-circle"></i>Play Trailer</a>
                                    <a class="btn btn-slider-pro buy-video"  data-prop="{{ $video }}" data-type="buy" href="#"><i class="fas fa-money-bill"></i>Buy</a>
                                    <a class="btn btn-slider-pro rent-video"  data-prop="{{ $video }}" data-type="rent"  href="#"><i class="fas fa-money-bill"></i>Rent </a>
