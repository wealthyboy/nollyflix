                            ...
                            <div class="cart-product-table-wrap ">
                                ...
                                <div class="col-md-7 col-6">
                                    ...
                                    <div class="product--share  mt-3"><span class="bold">Type #:</span> {{ $cart->purchase_type }}   
                                      @if( $cart->purchase_type == 'rent' )
                                         <span class="ml-2 border"">{{ $cart->purchase_type == 'rent'  ? " Expires after 48hours" : ""}}</span>
                                      @endif
                                    </div>
                ...
                <div class="cart-collateralse  border pb-3 pt-3 pl-3 pt-3 pr-3 raised">
                    <div class="cart_totalse">
                        ...
                        <div class="proceed-to-checkout">
                            <a  data-user="{{ auth()->user() }}" data-currency="" data-total="" href="#" class="checkout-button btn  w-100  fa-2x">Make Payment</a></div>
                    </div>
                </div>
                </div>
            </div>
