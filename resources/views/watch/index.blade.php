...
<div  class="background_video hide">
    ...
    <video id="video"  data-setup='{"nativeControlsForTouch": false}'  poster="{{ optional($video)->poster }}"  muted  disablePictureInPicture nodownload  class="video-js vjs-default-skin"   
        controls 
        >
