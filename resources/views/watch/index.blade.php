...
<div  class="background_video hide">
    ...
    <video id="video"  data-setup='{"customControlsOnMobile": true}'  poster="{{ optional($video)->poster }}"  muted  disablePictureInPicture nodownload  class="video-js vjs-default-skin"   
        controls 
        >
