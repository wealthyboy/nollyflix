                   ...
                   <div class="tab-pane" id="ProductData">
                      ...
                      <div class="row">
                         <div class="col-md-8">
                               ...
                               <div class="col-md-12">
                                  ...
                                  <div class="row">
                                     <div class="col-md-3">
                                        <div class="radio">
                                           <label>
                                              <input type="radio" value="movie" name="content_type" {{ old('content_type', $video->content_type ?? 'movie') == 'movie' ? 'checked' : '' }}>
                                              Movie
                                           </label>
                                        </div>
                                     </div>
                                     <div class="col-md-3">
                                        <div class="radio">
                                           <label>
                                              <input type="radio" value="series" name="content_type" {{ old('content_type', $video->content_type ?? 'movie') == 'series' ? 'checked' : '' }}>
                                              Series
                                           </label>
                                        </div>
                                     </div>
                            ...
                            <div class="row">
                               <div class="col-md-12">
                                  <div class="form-group label-floating">
                                     ...
                                     <input name="buy_price_usd" type="text" value="{{ $video->buy_price_usd ?? old('buy_price_usd') }}" class="form-control">
                                     <span class="material-input"></span>
                                  </div>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-12">
                                  <div class="form-group label-floating">
                                     ...
                                     <input name="rent_price_usd" type="text" value="{{ $video->rent_price_usd ?? old('rent_price_usd') }}" class="form-control">
                                     <span class="material-input"></span>
                                  </div>
                               </div>
                            </div>
                            <div class="row">
                               <div class="col-md-12">
                                  <div class="form-group label-floating">
                                     ...
                                     <input name="link" data-movie-required="true" data-msg="Enter video link" type="text" value="{{ $video->link ?? old('link') }}" class="form-control">
                                     <span class="material-input"></span>
                                  </div>
                               </div>
                            </div>
                            ...
                            @php
                               $savedEpisodes = $video->episodes->map(function ($episode) {
                                  return [
                                     'id' => $episode->id,
                               ...
                               <div class="episode-rows">
                                  ...
                                  <div class="panel panel-default episode-row">
                                     <div class="panel-body">
                                        <input name="episodes[{{ $index }}][id]" type="hidden" value="{{ $episode['id'] ?? '' }}">
                                        <div class="row">
                                           <div class="col-md-2">
                                              <div class="form-group label-floating">
 ...
 '<div class="panel-body">' +
 '<input name="episodes[' + index + '][id]" type="hidden" value="">' +
 '<div class="row">' +
 '<div class="col-md-2"><div class="form-group label-floating"><label class="control-label">Season</label><input name="episodes[' + index + '][season_number]" type="number" min="1" value="1" class="form-control"></div></div>' +
 '<div class="col-md-2"><div class="form-group label-floating"><label class="control-label">Episode</label><input name="episodes[' + index + '][episode_number]" type="number" min="1" value="' + (index + 1) + '" class="form-control"></div></div>' +
 '<div class="col-md-4"><div class="form-group label-floating"><label class="control-label">Episode title</label><input name="episodes[' + index + '][title]" type="text" class="form-control"></div></div>' +
 '<div class="col-md-2"><div class="form-group label-floating"><label class="control-label">Duration</label><input name="episodes[' + index + '][duration]" type="text" class="form-control"></div></div>' +
