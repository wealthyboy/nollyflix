...
class BrowseController extends Controller
{
    ...
    {   
        ...
        return BrowseResource::collection(
            $sections->load('videos','videos.casts.cast_videos', 'videos.filmers.filmer_videos', 'videos.related_videos.video','videos.related_videos.video.casts.cast_videos','videos.related_videos.video.filmers.filmer_videos')
        )
        ->additional(['meta' => [
